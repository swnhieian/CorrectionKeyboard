...
public class KeyboardView extends View {
    ...
    private EditTextProcessor processor;
    public void setProcessor(EditTextProcessor p) { this.processor = p;}
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (time - downTime > 150 && screenPoints.size() > 0) {
                    ...
                    processor.beginCorrection(new ArrayList<Point>(screenPoints), deltaX, deltaY);
    ...
    public List<Point> getRawInputPoints() {
        return screenPoints;
    }
   private static boolean isCharArea(float x, float y) {
   ...
   public static char getRawChar(Point pos) {
